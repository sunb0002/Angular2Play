...
export class HeaderComponent implements OnInit {
  ...
  updateDate(): void {
    ...
    const Obs = {
      ...
      error: (err) => {
        console.error('wwwwwError=' + err);
      },
      complete: () => {
        console.warn('wwwwwCompleted!');
      }
    };
